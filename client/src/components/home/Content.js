  ...
  return (
    <>
        ...
        <h1 className='animate-text text-7xl text-center text-transparent bg-clip-text bg-gradient-to-r from-red-700 via-purple-700 to-blue-700'>Welcome to <b>CourseLite!</b></h1>
              ...
              <form action="#">
                <button type="button" className="text-white w-36 h-18 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                    Get Started!
                </button>
            </form>
        </div> 
